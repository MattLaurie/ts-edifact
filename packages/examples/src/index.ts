...
import { EdifactMessageSpecification, MessageStructureParser, Suffix, UNECEMessageStructureParser } from "@ts-edifact/core";
...
function storeAllDefaultSpecs(version: string, location: string, messages: string[]): void {
    

    for (const typeName of messages) {
...
storeAllDefaultSpecs('d99b', './spec', [
    'CUSCAR',
    'CUSDEC',
    'CUSPED',
    'CUSREP',
